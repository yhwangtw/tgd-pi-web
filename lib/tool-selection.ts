export type ToolSelectionMode = "inherit" | "none" | "default" | "full" | "custom";
...
export const TOOL_PRESET_DEFAULT = ["read", "bash", "edit", "write", "ask_user"] as const;
export const TOOL_PRESET_FULL = ["read", "bash", "edit", "write", "grep", "find", "ls", "ask_user"] as const;
